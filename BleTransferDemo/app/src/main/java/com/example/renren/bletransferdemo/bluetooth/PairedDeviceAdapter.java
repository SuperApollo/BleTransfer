...
public class PairedDeviceAdapter extends RecyclerView.Adapter<PairedDeviceAdapter.ViewHolder> {
    ...
    public PairedDeviceAdapter(List<BluetoothDevice> deviceList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.tvName.setText("名称：" + bluetoothDevice.getName());
        holder.tvAddress.setText("地址：" + bluetoothDevice.getAddress());
